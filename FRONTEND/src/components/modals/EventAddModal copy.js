...
const [desc, setDesc] = useState("");
   ...
   const handleAddEvent = async() =>{
    setAddLoader(true);
    await postEvent({owneremail:user.email,eventid:eventid,name:eventname,urlAlias:eventid,organizer:contactemail,email:contactemail,openedDate:eventdate,mode:eventmode,desc:"shit"});
    setAddLoader(false);
    onClose();
   }
